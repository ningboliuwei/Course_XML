<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisplayCellphones.aspx.cs" Inherits="XmlDocument的使用_使用XmlDocument读取XML文档_实验._Default" %>
...
<html>
    ...
    <body bgcolor="#cc99ff">
        <form id="Form1" runat="server">
            ...
            <br />
            兼容网络制式：
            <asp:CheckBoxList ID="cblNetwork" runat="server" RepeatDirection="Horizontal"
                              RepeatColumns="1">
