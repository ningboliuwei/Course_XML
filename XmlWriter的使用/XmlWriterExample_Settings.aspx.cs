...
namespace XmlWriter的使用
{
	...
	public partial class XmlWriterExample_Settings : System.Web.UI.Page
	{
		...
		protected void btnWrite_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				settings.ConformanceLevel = ConformanceLevel.Auto;//设置一致性级别，详见：http://msdn.microsoft.com/zh-cn/library/50f80zbz(v=vs.110).aspx
